...
const AdminLayout = ({ user, onLogout, children }) => {
    ...
    const navItems = [
        ...
        { label: 'Inventory', path: '/admin/inventory', icon: 'M20 13V7a2 2 0 00-2-2h-3V3H9v2H6a2 2 0 00-2 2v6m16 0v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6m16 0h-4m-8 0H4m8 0v4' },
        { label: 'Refunds Ledger', path: '/admin/refunds', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ...
        { label: 'Gate Scanner', path: '/admin/scanner', icon: 'M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 0112 4.54a10.003 10.003 0 017.14 13.9a1.996 1.996 0 01-1.745 1.1c-.8 0-1.56-.32-2.12-.888l-3.23-3.23a2.003 2.003 0 00-2.82 2.82l2.12 2.12c.56.56.88 1.32.88 2.12V21' },
        { label: 'Notifications', path: '/admin/notifications', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V4a2 2 0 10-4 0v1.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
        { label: 'Reports', path: '/admin/reports', icon: 'M9 17v-6m3 6V7m3 10v-3m4 5H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v12a2 2 0 01-2 2z' },
